...
All'interno del repository deve essere presente un file README.md contente la descrizione dei seguenti punti:
    ...
    - il dettaglio di come avviene il parsing delle righe del file di testo name.basics.tsv nel programma Java
...
NOTA: manca il punto 2 che è in branching
...
** Tempi medi:
Java: ~2 min su lab2 (~1 su laptop)
*C (intera bfs): ~14 sec su lab2 (~9 su laptop)
